...
I'm really excited to have the [`r2pptx`](https://mattle24.github.io/r2pptx/)
package on CRAN! `r2pptx` is designed to provide a beginner-friendly interface
to make Powerpoint presentations in R. It can be a really helpful package to use
if you often create slide decks that contain tables, plots, or calculations that
come from R code. 

`r2pptx` is built as a wrapper around
[`officer`](https://davidgohel.github.io/officer/), and wouldn't be possible
without all of `officer` developer David Gohel's hard work. Thanks David!

In this post I'll go through how to make a basic presentation using `r2pptx`, as
well as how to make a more advanced presentation.
...
this only supports a placeholder label. Placeholder labls are the name of placeholders, 
...
In a more advanced example, we may want to produce a number of similar slides.
...
```{r}
# make a slidelist - a new class of object that is just meant to be a helpful
# way to hold slides that aren't part of a presentation yet
